  ...
  $details = mysqli_fetch_array($companyDetails);

  function customCompanyDescriptionButton($name = null)
  {
    echo '<a class="btn btn--radius-2 btn--blue" target="__blank" href="?edit_company_description=10">'.$name.'</a>';
  }
            ...
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
                            <li><a href="companyProfile.php" class="active">Profil</a></li>
                ...
                <div class="col-md-4 mb-3">
                  <div class="card">
                    <div class="card-body">
                      ...
                      <input type="hidden" name="id_companie" value="<?php  echo $id;  ?>">
                        <img src="pozeCompanii/<?php echo $details['poza']; ?>" alt="img_<?php echo $details['denumire']; ?>" class="img-thumbnail" width="150" onerror="this.onerror=null;this.src='https://www.bootdey.com/app/webroot/img/Content/Manbrown2.png';">
                  ...
                  <form method="post" action="dbServices.php">
                    <ul class="list-group list-group-flush">
                      ...
                      <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                        <h5 class="mb-0">Descrierea companiei</h5>
                        <hr>
                      ...
                      <?php if (($details['descriere'] == null || empty($details['descriere'])) && !$editStateDesc) {
                        customButton("edit_company_description",$details['id_companie'],"Adaugă");
                      } ?>
                      <?php if (($editStateDesc || $isForEdit)) { $isForEdit = true; ?>
                        <button class="btn btn--radius-2" style="background: green;" target="__blank" type="submit" name="update_company_description">Salveaza</button>
                     <?php } ?>

                     <?php if (($details['descriere'] != null && !$isForEdit)) {
                      customButton("edit_company_description",$details['id_companie'],"Editează");
                ...
                <form method="post" action="dbServices.php">
                  <div class="card mb-3">
                    <div class="card-body">
                        ...
                        <div class="row">
                        <div class="col-sm-3">
                          <h6 class="mb-0">Denumire</h6>
                        </div>
                        <div class="col-sm-9 text-secondary">
                        <?php if($edit_state == false): ?>
                          <?php echo $details['denumire']; ?>
                          <?php else: ?>
                            <input type="text" name="denumire" class="form-control" value="<?php echo $details['denumire'];  ?>">
                        <?php endif ?>
                        </div>
                      </div>
                      <hr>
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-9 text-secondary">
                          <?php if($edit_state == false): ?>
                          <?php echo $details['email_companie']; ?>
                          <?php else: ?>
                            <input type="text" name="email_companie" class="form-control" value="<?php echo $details['email_companie'];  ?>">
                        <?php endif ?>
                        </div>
                      </div>
                      <hr>
                      ...
                      <div class="row">
                        ...
                        <div>
                          ...
                          <?php if($edit_state == false): ?>
                            ...
                            <a class="btn btn--radius-2 btn--blue " target="__blank" href="companyProfile.php?edit_company_profile=<?php echo $details['id_companie']; ?>">Editează</a>
